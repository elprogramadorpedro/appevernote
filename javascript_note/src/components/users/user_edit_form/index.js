  ...
  return (
    <Fragment>
      <form onSubmit={handleSubmit}>
        <Field>
          <Control>
            <Label className="has-text-grey">Full NameLabel</Label>
            <Input
              type="name"
              value={name || ""}
        ...
        <Field>
          <Control>
            <Label className="has-text-grey">EmailLabel</Label>
            <Input
              type="email"
              value={email || ""}
          ...
          <Control>
            <Column.Group>
              <Column className="has-text-right">
                <Button color="custom-purple" outlined>UpdateButton </Button>
                </Column>
                </Column.Group>
                </Control>
                </ Field>
